...
import com.serge.chuckstaplist.ui.components.TutorialOverlay
...
class TapListUi(
    ...
    override fun Content(state: TapListUiState, modifier: Modifier) {
        ...
        val showTutorial by rememberRetained { preferencesRepository.shouldShowTutorial }.collectAsState(initial = false)
        ...
        BoxWithConstraints(
            ...
            val highlightedTapState by highlightedTapState(state.filteredTaps, scrollState)
            val (highlightedTap, colorIndex) = highlightedTapState

            LazyColumn(Modifier.fillMaxSize(), scrollState) {
                item { TitleHeaderItem(state, coroutineScope) }
            ...
            TutorialOverlay(
                ...
                modifier = modifier,
                onDismiss = { coroutineScope.launch { preferencesRepository.setTutorialShown(true) } }
            )
        }
    }

    @Composable
    private fun TitleHeaderItem(state: TapListUiState, coroutineScope: CoroutineScope) {
            ...
            Icon(
                ...
                modifier =
                    Modifier
                        ...
                        .clickable { coroutineScope.launch { preferencesRepository.setTutorialShown(false) } }
                        .padding(horizontal = 16.dp, vertical = 8.dp),
                tint = Color.White
            )
        }
